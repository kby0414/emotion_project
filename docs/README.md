...
이 폴더는 데이터 준비부터 최종 모델 전달까지 수행한 작업을 단계별로 정리한다. 처음 프로젝트를 받는 팀원은 아래 순서대로 읽으면 된다.
...
| 4 | [모델 학습과 선정](04_model_training_and_selection.md) | 세 모델 구조, 학습 설정, 체크포인트, 선정 근거 |
| 5 | [평가와 시각화](05_evaluation_and_visualization.md) | Accuracy, Macro-F1, 혼동행렬, 최종 비교 결과 |
...
- 최종 후보 모델: `models/GPU_efficientnet_b0_e50_p3_b32/efficientnet_b0/best.pt`
...
- 최종 1위: EfficientNet-B0, Accuracy 0.7400, Macro-F1 0.7357
